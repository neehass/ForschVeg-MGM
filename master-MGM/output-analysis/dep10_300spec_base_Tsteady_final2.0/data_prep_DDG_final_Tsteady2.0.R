...
# project: dep10_300spec_base_Tprofile_final2.0
...
out_Tprofile <- "output/dep10_300spec_base_Tsteady_final2.0"
save_Tprofile <- "output-analysis/dep10_300spec_base_Tsteady_final2.0"

dir.create(save_Tprofile)

save_comparison <- "output-analysis/dep10_300spec_base_Tsteady_final2.0/DDG"
dir.create(save_comparison)

name1 <- "Tsteady-final2.0"
