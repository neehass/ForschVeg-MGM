...
# Visualise Results
# -------------------------------------------------------------------------------------------
# projekt: dep10_300spec_base_Tprofile_final2.0
...
output <- "output/dep10_300spec_base_Tprofile_final2.0"

out_ana_path <- "output-analysis/dep10_300spec_base_Tprofile_final2.0"

save_figures <- "output-analysis/dep10_300spec_base_Tprofile_final2.0/figures"
