...
# Visualise Results
# -------------------------------------------------------------------------------------------
# projekt: dep10_300spec_base_Tprofile_20years_deep
...
output <- "output/dep10_300spec_base_Tprofile_20years_deep"

out_ana_path <- "output-analysis/dep10_300spec_base_Tprofile_20years_deep"

save_figures <- "output-analysis/dep10_300spec_base_Tprofile_20years_deep/figures"
name <- "Tprofile_20years_deep"

scenario <- "base Tprofile deep"
...
p_Tprofile <- ggplot(mean_profiles, aes(x = depth, y = T_prof_mean, color = AreaGroup, 
  ...
  scale_x_reverse(breaks = depth_bio, limits = c(-5,-9),) + # 
