...
# Visualise Results
# -------------------------------------------------------------------------------------------
# projekt: test_oli_plus5_notparallel
...
output <- "output/test_oli_plus5_notparallel"

out_ana_path <- "output-analysis/test_oli_plus5_notparallel"

save_figures <- "output-analysis/test_oli_plus5_notparallel/figures"
