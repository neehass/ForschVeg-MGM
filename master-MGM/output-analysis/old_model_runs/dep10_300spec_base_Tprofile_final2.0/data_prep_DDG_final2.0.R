...
out_Tprofile <- "output/dep10_300spec_base_Tprofile_final2.0"
save_Tprofile <- "output-analysis/dep10_300spec_base_Tprofile_final2.0"

dir.create(save_Tprofile)

save_comparison <- "output-analysis/dep10_300spec_base_Tprofile_final2.0/DDG"
