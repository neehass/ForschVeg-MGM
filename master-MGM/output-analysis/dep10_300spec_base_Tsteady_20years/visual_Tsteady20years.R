...
# Visualise Results
# -------------------------------------------------------------------------------------------
# projekt: dep10_300spec_base_Tsteady_20years
...
output <- "output/dep10_300spec_base_Tsteady_20years"

out_ana_path <- "output-analysis/dep10_300spec_base_Tsteady_20years"

save_figures <- "output-analysis/dep10_300spec_base_Tsteady_20years/figures"
name <- "Tsteady_20years"
...
p_Tprofile_DAY_all
ggsave(file.path(save_figures, paste0(name,"_perAproxMonth.png")), p_Tprofile_DAY_all, 
