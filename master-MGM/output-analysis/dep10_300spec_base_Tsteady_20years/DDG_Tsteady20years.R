...
# load data from data-analysis-prep.R function: func_prep_data_fast
# project: dep10_300spec_base_Tsteady_20years
...
save_comparison <- "output-analysis/dep10_300spec_base_Tsteady_20years/DDG"
name1 <- "Tsteady_20years"
