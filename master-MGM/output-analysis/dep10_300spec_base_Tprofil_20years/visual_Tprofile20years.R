...
output <- "output/dep10_300spec_base_Tprofil_20years"

out_ana_path <- "output-analysis/dep10_300spec_base_Tprofil_20years"

save_figures <- "output-analysis/dep10_300spec_base_Tprofil_20years/figures"
name <- "Tprofile_20years"
