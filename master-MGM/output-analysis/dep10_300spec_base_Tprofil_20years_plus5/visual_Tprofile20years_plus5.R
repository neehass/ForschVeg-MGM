...
# Visualise Results
# -------------------------------------------------------------------------------------------
# projekt: dep10_300spec_base_Tprofil_20years
...
output <- "output/dep10_300spec_base_Tprofil_20years_plus5"

out_ana_path <- "output-analysis/dep10_300spec_base_Tprofil_20years_plus5"

save_figures <- "output-analysis/dep10_300spec_base_Tprofil_20years_plus5/figures"
name <- "Tprofile_20years_plus5"
...
p_combo <-  p_box + p_Tprofile + plot_layout(guides = "collect") +
  ...
  theme(legend.position = "bottom")
p_combo
ggsave(file.path(save_figures, paste0("BOX-temp",name,"_biomass_day.png")), p_combo, height = 10, width = 12)
