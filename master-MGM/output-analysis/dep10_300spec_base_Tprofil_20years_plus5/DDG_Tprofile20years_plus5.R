...
# project: dep10_300spec_base_Tprofil_20years_plus5
...
save_comparison <- "output-analysis/dep10_300spec_base_Tprofil_20years_plus5/DDG"
name1 <- "Tprofile_20years_plus5"
