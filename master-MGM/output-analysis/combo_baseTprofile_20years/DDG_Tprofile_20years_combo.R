...
# ---------------------------------------------------------------------------------
# dir setup ---------------------------------------------------------------------------------
out_ana_path_top <- "output-analysis/dep10_300spec_base_Tprofil_20years/DDG"
nametop <- "Tprofile_20years"
out_ana_path_deep <- "output-analysis/dep10_300spec_base_Tprofile_20years_deep/DDG"
namedeep <- "Tprofile_20years_deep"

# combo 
save_comparison <- "output-analysis/combo_baseTprofile_20years/DDG"
save_out <- "output-analysis/combo_baseTprofile_20years"

scenario <- "base Tprofile"
name1 <- "Tprofile_20years_combo"
